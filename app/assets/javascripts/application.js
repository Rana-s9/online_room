...
var board_controller_default = class extends Controller {
  static values = {
    roomId: Number,
    whiteboardId: Number
  };
  ...
  save() {
    ...
    this.timeout = setTimeout(() => {
      ...
      const url = this.whiteboardIdValue ? `/rooms/${this.roomIdValue}/whiteboards/${this.whiteboardIdValue}` : `/rooms/${this.roomIdValue}/whiteboards`;
      ...
      fetch(url, {
        ...
        body: JSON.stringify({ whiteboard: { body } })
      }).then((response) => {
...
var diary_controller_default = class extends Controller {
  static values = {
    roomId: Number,
    diaryId: Number
  };
  ...
  save() {
    ...
    this.timeout = setTimeout(() => {
      ...
      const url = this.diaryIdValue ? `/rooms/${this.roomIdValue}/exchange_diaries/${this.diaryIdValue}` : `/rooms/${this.roomIdValue}/exchange_diaries`;
      ...
      fetch(url, {
        ...
        body: JSON.stringify({ exchange_diary: { body } })
      }).then((response) => {
        if (!response.ok) throw new Error("\u4FDD\u5B58\u5931\u6557");
...
application.register("board", board_controller_default);
application.register("diary", diary_controller_default);
